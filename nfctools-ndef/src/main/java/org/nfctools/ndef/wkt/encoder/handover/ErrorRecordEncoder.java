...
public class ErrorRecordEncoder implements RecordEncoder {

	@Override
	public boolean canEncode(Record record) {
		return record instanceof ErrorRecord;
	}
	...
	public NdefRecord encodeRecord(Record record, NdefMessageEncoder messageEncoder) {
		...
		case PermanenteMemoryConstraints : {
			...
			payload = new byte[]{errorReason.getValue(), (byte)((unsignedInt >> 24) & 0xFF), (byte)((unsignedInt >> 16) & 0xFF), (byte)((unsignedInt >> 8) & 0xFF), (byte)(unsignedInt & 0xFF)};
		...
		return new NdefRecord(NdefConstants.TNF_WELL_KNOWN, ErrorRecord.TYPE, record.getId(), payload);
	}
