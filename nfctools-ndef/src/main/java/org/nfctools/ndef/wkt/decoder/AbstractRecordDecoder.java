...
public abstract class AbstractRecordDecoder<T extends Record> implements RecordDecoder<T> {
	...
	protected abstract T createRecord(NdefRecord ndefRecord, NdefDecoder messageDecoder);

	@Override
	public T decodeRecord(NdefRecord ndefRecord, NdefDecoder messageDecoder) {
